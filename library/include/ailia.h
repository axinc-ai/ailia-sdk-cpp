 ...
 * また、mmap高速化のため一時ファイルを作成します。そのためailiaSetTemporaryCachePathを呼び出してください。
 * 呼び出しを行わない場合重みファイルオープン時にAILIA_STATUS_INVALID_STATEが返ります。
 * AILIA_MEMORY_REDUCE_INTERSTAGEおよびAILIA_MEMORY_REUSE_INTERSTAGEと併用することが可能です。
 *
 * \~english
 ...
 * If do not call ailiaSetTemporaryCachePath and specify this, it will return error
 * `AILIA_STATUS_INVALID_STATE` when call ailiaOpenWeightXXX.
